const Billboard: React.FC = () => {
    ...
    return (
      <div className="relative h-[56.25vw]">
        <video 
        poster="https://upload.wikimedia.org/wikipedia/commons/7/70/Big.Buck.Bunny.-.Opening.Screen.png" className="w-full h-[56.25vw] object-cover brightness-[60%] transition duration-500" autoPlay muted loop 
